...
export default function AssignmentBlock({ 
  ...
  const handleFileSelect = (e) => {
    ...
    if (file) onFileUpload(block, file, weekId, sectionId);
  };
    ...
    <div className="bg-white border border-gray-300 rounded-md p-4 mb-4 shadow-sm">
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1">
          ...
          {/* SUBMISSION UI (hidden if submissionType === "null") */}
          {block.submissionType !== 'null' && (
            isSubmitted ? (
              <div className="bg-gray-100 rounded-md p-3 border border-gray-200">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Submitted on:{' '}
                  {submission.submittedAt?.toDate?.()?.toLocaleString() || 'Just now'}
                </p>
                ...
                {block.submissionType === 'text' && (
                  <>
                    ...
                    <button
                      ...
                      className="mt-2 flex items-center gap-1 px-4 py-2 bg-gray-800 text-white rounded-md disabled:opacity-50"
                    >
                ...
                {block.submissionType === 'file' && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-4 py-2 bg-gray-800 text-white rounded-md disabled:opacity-50"
                    >
